...
{{----------------------------------------------------------------------------------------------------------------}}
                    ...
                    <table style="width: 100%; background-color:#f4f5f7; padding:5px" >
                        ...
                        <tr><td rowspan="6" style="width: 100px"><img src="{{$product->image_url}}"  width="100" height="80" alt=""></td></tr>
                        <tr><td width='60'>السعر</td><td style="text-align: right">{{ $product->price }}
                        ...
                        <tr><td></td><td style="text-align: right"><a href="{{ Route('vendor.products.edit', $product->id) }}"
                            class="btn btn-warning btn-sm">
                            <i class="fa fa-edit"></i>
                        </a>
                        <form action="{{ Route('vendor.products.destroy', $product->id) }}" method="post"
                        ...
                        <tr><td> </td>
                            <td>
                            <a href="{{Route('vendor.product_variants.create',$product->id)}}" class="btn btn-primary btn-sm">
                                {{ trans('products_trans.Add_Variant') }} {{$product->product_variants_count}}
                            </a>
                        </td></tr>
